...
- `UPOS`: reserved/internal pose stream (not part of public launch API)
...
`POSE` is the public launch stream.
...
- bit 2: linear velocity in body frame (`linvel`, f64 x3)
- bit 3: angular velocity in body frame (`angvel`, f64 x3)
- bit 4: linear acceleration in body frame (`linacc`, f64 x3)
- bit 5: angular acceleration in body frame (`angacc`, f64 x3)
