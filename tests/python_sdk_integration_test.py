...
class IntegrationState:
    def __init__(self):
        ...
        self.stream_chunks = [
            ...
            mp.make_packet(mp.TYPE["POSE"], build_pose_payload(pose_type=0, pose_flags=0, position=(1.0, 2.0, 3.0), confidence=0.9, timestamp_ns=11)),
...
def main():
    ...
    try:
        ...
        client.on_pose(lambda _: seen.__setitem__("pose", seen["pose"] + 1))
